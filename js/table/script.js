...
function tableSetBorder() {
	table.style.border = document.getElementById("border-btn").parentElement.children[0].value + "px " + document.getElementById("border-btn").parentElement.children[1].value + " red"
}
